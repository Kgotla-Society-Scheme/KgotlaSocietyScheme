...
import za.co.kss.domain.Address;
import za.co.kss.repository.AddressRepository;
import za.co.kss.service.AddressService;
import za.co.kss.service.dto.AddressDTO;
import za.co.kss.service.mapper.AddressMapper;
...
public class AddressResourceIT {
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getComplexName()).isEqualTo(DEFAULT_COMPLEX_NAME);
    ...
    public void updateAddress() throws Exception {
        ...
        assertThat(testAddress.getComplexName()).isEqualTo(UPDATED_COMPLEX_NAME);
